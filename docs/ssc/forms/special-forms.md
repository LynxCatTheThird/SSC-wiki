...
按住跳跃键可以上升，单次最多持续 80 tick，也就是 4 秒；飞行时移动速度提高 16%。悦灵可以走过细雪，并拥有缓降与落地免疫。
...
猫与豹猫把玩家视为友好目标，苦力怕会主动远离。安装 Tough As Nails 时，野猫额外获得轻度寒冷抗性与脏水口渴保护；未安装该模组时，这两项兼容能力不会产生原版温度机制。
...
安装幻形者诅咒扩展包后，悦灵和野猫都有两条终局分支。全部目标集中列在 [幻形者诅咒扩展包形态目录](../../../addons/ssca/forms/overview)，进化道具、月相条件和失败后果见 [进化系统](../../../addons/ssca/systems/evolution)。

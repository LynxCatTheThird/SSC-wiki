...
蝙蝠形态线是一条夜行和空中机动路线。随着阶段提高，玩家获得夜视、高跳、缓降、墙面附着和空中移动能力，但日光、地面移动、护甲和武器使用限制也更加明显。[^source]

...
幻形者诅咒扩展包统一管理 SP 悦灵 Mana、吸血蝙蝠血渴、冥裁者灵魂能量、SP 雪狐霜寒和寄生果蝠种子量。设当前值为 $R$、上限为 $M$、本次变化为 $\Delta R$，写入后的值为：
...
美西螈路线用原版空气条承载湿润值。基础最大值为 300 点；陆地上每秒减少 3 点。进化美西螈解锁 “成为水” 前，还会每 2 秒额外减少 3 点。下雨、入水、能力与装备会改变这个过程。

...
flowchart LR
  ...
  SNOW["幻形者诅咒雪狐第4阶段"] -->|"月髓十字环"| FROST["寒棘狐"]
  SNOW -->|"进化石"| SSP["SP雪狐 / 寒霜之灵"]
  ANU["幻形者诅咒胡狼第4阶段"] -->|"月髓十字环"| JUDGE["冥裁者"]
  ANU -->|"进化石"| SAND["金沙岚"]
  BAT["幻形者诅咒蝙蝠第4阶段"] -->|"月髓十字环"| VAMP["吸血蝙蝠"]
  BAT -->|"进化石"| FRUIT["寄生果蝠"]
  OCE["幻形者诅咒豹猫第4阶段"] -->|"月髓十字环"| WIND["风灵"]
  OCE -->|"进化石"| NOVA["朔望"]
  SPI["幻形者诅咒蜘蛛第4阶段"] -->|"月髓十字环"| WEAVER["月织蛛"]
  SPI -->|"进化石"| JUMP["跳蛛"]
  ALLAY["幻形者诅咒悦灵特殊形态"] -->|"月髓十字环"| FALLEN["SP堕落悦灵"]
  ALLAY -->|"进化石"| ALLAYSP["SP悦灵 / 水晶之音"]
  CAT["幻形者诅咒野猫特殊形态"] -->|"月髓十字环"| NIGHT["食梦魔"]
...
| 阿澪        | 荧光幼灵剧情特殊变体     | 延长潮汐牵引，三连发缩型激光，降低陆地湿润流失            | 每道激光 14.4 点物理伤害（12×1.2）；潮汐时长与飞行上限各增加 20%            |

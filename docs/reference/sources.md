...
幻形者诅咒与幻形者诅咒扩展包的代码、资源、文档和故事内容可能适用不同许可证。当前 MC 百科条目将幻形者诅咒扩展包代码记为 MIT，但上游仓库 `README` 与根目录 `LICENSE` 仍标为 AGPL-3.0-or-later，二者存在冲突；本站不据此替作者选择协议。转载故事文本、模型、纹理或游戏内书籍前必须核对原项目许可；必要时只提供摘要、索引和来源链接。

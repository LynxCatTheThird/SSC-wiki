...
<FormModelViewer
  stages={{
    ocelot_0: {
      ...
      model: '/models/forms/shape-shifter-curse/ocelot/ocelot_0.gltf',
    },
    ocelot_1: {
      label: '第一阶段',
      title: '豹猫第一阶段 · ocelot_1.gltf',
      model: '/models/forms/shape-shifter-curse/ocelot/ocelot_1.gltf',
    },
    ocelot_2: {
      label: '第二阶段',
      title: '豹猫第二阶段 · ocelot_2.gltf',
      model: '/models/forms/shape-shifter-curse/ocelot/ocelot_2.gltf',
    },
    ocelot_3: {
      label: '永久阶段',
      title: '豹猫永久阶段 · ocelot_3.gltf',
      model: '/models/forms/shape-shifter-curse/ocelot/ocelot_3.gltf',
    },
  }}
  animations={{

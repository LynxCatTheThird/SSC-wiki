...
<FormModelViewer
  stages={{
    familiar_fox_0: {
      ...
      model: '/models/forms/shape-shifter-curse/familiar_fox/familiar_fox_0.gltf',
    },
    familiar_fox_1: {
      label: '第一阶段',
      title: '使魔红狐第一阶段 · familiar_fox_1.gltf',
      model: '/models/forms/shape-shifter-curse/familiar_fox/familiar_fox_1.gltf',
    },
    familiar_fox_2: {
      label: '第二阶段',
      title: '使魔红狐第二阶段 · familiar_fox_2.gltf',
      model: '/models/forms/shape-shifter-curse/familiar_fox/familiar_fox_2.gltf',
    },
    familiar_fox_3: {
      label: '永久阶段',
      title: '使魔红狐永久阶段 · familiar_fox_3.gltf',
      model: '/models/forms/shape-shifter-curse/familiar_fox/familiar_fox_3.gltf',
    },
  }}
  animations={{
...
[^source]: 源码核对：幻形者诅咒 `origins/form_familiar_fox_*.json`、Mana 和生物交互能力；未确认的交互不会写作确定结论。

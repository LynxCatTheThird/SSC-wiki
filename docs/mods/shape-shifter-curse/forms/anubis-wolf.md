...
| 名称             | 命名空间 ID     | 本地化键名                           |
| ---------------- | --------------- | ------------------------------------ |
| 胡狼形态初始阶段 | `anubis_wolf_0` | `shape-shifter-curse.anubis_wolf_0` |
| 胡狼形态第一阶段 | `anubis_wolf_1` | `shape-shifter-curse.anubis_wolf_1` |
| 胡狼形态第二阶段 | `anubis_wolf_2` | `shape-shifter-curse.anubis_wolf_2` |
| 胡狼形态永久阶段 | `anubis_wolf_3` | `shape-shifter-curse.anubis_wolf_3` |
...
<FormModelViewer
  stages={{
    anubis_wolf_0: {
      ...
      model: '/models/forms/shape-shifter-curse/anubis_wolf/anubis_wolf_0.gltf',
    },
    anubis_wolf_1: {
      label: '第一阶段',
      title: '胡狼第一阶段 · anubis_wolf_1.gltf',
      model: '/models/forms/shape-shifter-curse/anubis_wolf/anubis_wolf_1.gltf',
    },
    anubis_wolf_2: {
      label: '第二阶段',
      title: '胡狼第二阶段 · anubis_wolf_2.gltf',
      model: '/models/forms/shape-shifter-curse/anubis_wolf/anubis_wolf_2.gltf',
    },
    anubis_wolf_3: {
      label: '永久阶段',
      title: '胡狼永久阶段 · anubis_wolf_3.gltf',
      model: '/models/forms/shape-shifter-curse/anubis_wolf/anubis_wolf_3.gltf',
    },
  }}
  animations={{
...
[^source]: 源码核对：幻形者诅咒 `origins/form_anubis_wolf_*.json`、召唤和伤害能力；未确认的交互不会写作确定结论。

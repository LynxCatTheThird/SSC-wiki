...
A transformation effect is the item that starts an Shape Shifter Curse form. Use it on yourself to enter the form, then gain experience to unlock later stages. Each form has its own stage IDs, instinct rules, equipment limits, and environmental costs.

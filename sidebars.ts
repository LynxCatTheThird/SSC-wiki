...
const sidebars: SidebarsConfig = {
  tutorialSidebar: [
    'index',
    {
      type: 'category',
      label: '入门',
      items: ['getting-started/installation', 'getting-started/first-transformation'],
    },
    {
      type: 'category',
      label: '核心玩法',
          ...
          items: [
            {
              type: 'category',
              label: '雪狐',
              items: ['ssca/forms/ssc/snow-fox/ice-spine', 'ssca/forms/ssc/snow-fox/sp'],
            },
            {
              type: 'category',
              label: '阿努比斯之狼',
            ...
            },
            {
              type: 'category',
              label: '蝙蝠',
              items: ['ssca/forms/ssc/bat/desmodus', 'ssca/forms/ssc/bat/parasitic-fruit'],
            },
            {
              type: 'category',
              label: '豹猫',
              items: ['ssca/forms/ssc/ocelot/wind-spirit', 'ssca/forms/ssc/ocelot/nova'],
            },
            {
              type: 'category',
              label: '蜘蛛',
              items: ['ssca/forms/ssc/spider/moon-weaver', 'ssca/forms/ssc/spider/salticidae'],
            },
          ],
        },
        {
          ...
          items: [
            {
              type: 'category',
              label: '悦灵',
              items: ['ssca/forms/special/allay/allay-sp', 'ssca/forms/special/allay/fallen'],
            },
            {
              type: 'category',
              label: '野猫',
              items: ['ssca/forms/special/wild-cat/nightmare', 'ssca/forms/special/wild-cat/sp'],
            },
          ],
        },
        {
          type: 'category',
          label: '系统与操作',
          items: ['ssca/numeric-systems', 'ssca/evolution', 'ssca/controls-and-safety'],
        },
        {
          type: 'category',
          label: '物品与装备',
